...
class TopicController extends Controller
{
    ...
    {
        $topics = Topic::with('users')->withCount(['posts','users'])->orderBy('posts_count', 'desc')->paginate(16);
    ...
    public function show(Topic $topic)
    {
        ...
        $posts = $topic->posts()->with(['topics','user','images'])->orderBy('created_at', 'desc')->withCount(['zans','reposts'])->get();
